...
export const useAssetStore = create<AssetStore>((set, get) => ({
  ...
  addAsset: async (form) => {
    ...
    const asset = await api.assets.create({
      ...
      recycleAmount: form.recycleAmount != null && form.recycleAmount !== 0 ? form.recycleAmount : form.recycleAmount === 0 ? 0 : null,
      targetDailyCost: form.targetDailyCost != null && form.targetDailyCost !== 0 ? form.targetDailyCost : form.targetDailyCost === 0 ? 0 : null,
      effectiveDays,
      dailyCost,
