...
import {
  LayoutDashboard, Package, TrendingUp, Menu, X,
  Trash2, Settings, User, Palette, Sparkles, DatabaseBackup,
  ChevronDown, LogOut, Trophy, Users, Bell, ShieldAlert, BarChart3, Globe, Code, Wand2, Clock
} from "lucide-react"
...
const bottomTabs = [
  ...
  { to: "/ai-advisor", label: "AI", icon: Wand2 },
  { to: "/settings/account", label: "我的", icon: User },
]
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="flex-1 space-y-4 px-3 py-4 overflow-y-auto max-h-[calc(100vh-8rem)]">
          {navGroups.map((group) => (
            <div key={group.title}>
